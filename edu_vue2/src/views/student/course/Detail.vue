...
export default {
  ...
  this.$router.replace({
    ...
    selectLesson(lesson, section) {
      // 跳转到学生课程播放页面
      this.$router.push({
        path: `/student/courses/${this.courseId}/lessons/${lesson.id}`,
        query: {
    ...
    viewHomeworkDetail(homework) {
      this.$router.push({
        path: `/student/courses/${this.courseId}/homework/${homework.id}`
      })
    },
    ...
    viewExamDetail(exam) {
      this.$router.push({
        path: `/student/courses/${this.courseId}/exams/${exam.id}`
      })
    },
  ...
  // 修复：/mycourse/student -> /student/courses
  this.$router.push({
    path: `/student/courses/${this.courseId}/exams/${exam.id}/answer`
  })
},
  ...
  this.$router.push({
    ...
    createNewThread() {
  this.$router.push({
    path: `/student/courses/${this.courseId}/community/posts/create`
  })
},
    
    viewThreadDetail(threadId) {
      this.$router.push({
        path: `/student/courses/${this.courseId}/community/posts/${threadId}`
      })
    },
    ...
    editThread(threadId) {
      this.$router.push({
        path: `/student/courses/${this.courseId}/community/posts/${threadId}/edit`
      })
    },
